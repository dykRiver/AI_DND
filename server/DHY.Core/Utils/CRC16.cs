public class CRC16
{
    ...
    public CRC16 Crc(ushort ucrc, byte[] buf)
    {
        crc = ucrc;
        Crc(buf);
        return this;
    ...
    public CRC16 Crc(byte[] buf, int off, int len)
    {
        if (buf == null)
        {
