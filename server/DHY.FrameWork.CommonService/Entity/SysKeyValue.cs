...
public sealed class SysKeyValue
{
    /// <summary>
    /// 主键ID
    /// </summary>
    ...
    /// 云平台编码
    /// </summary>       
    [SugarColumn(ColumnName = "cloudplatformcode", IsNullable = true, ColumnDescription = "云平台编码", Length = 100)]
    public string CloudPlatformCode { get; set; }

    /// <summary>
    /// 云平台描述
    /// </summary>       
    [SugarColumn(ColumnName = "cloudplatformdescribe", IsNullable = true, ColumnDescription = "云平台描述", Length = 100)]
