...
/// 系统作业任务服务 💥
/// </summary>
[ApiDescriptionSettings(Order = 320, Groups = [CommonConst.SysGroupName])]
public class SysJobService : IDynamicApiController, ITransient
{
    ...
    {
        if (_schedulerFactory.TryRunJob(input.JobId, out var _) != ScheduleResult.Succeed)
