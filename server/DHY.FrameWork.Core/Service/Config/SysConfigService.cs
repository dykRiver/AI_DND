...
/// 系统参数配置服务 💥
/// </summary>
[ApiDescriptionSettings(Order = 440, Groups = [CommonConst.SysGroupName])]
public class SysConfigService : IDynamicApiController, ITransient
{
    ...
    public async Task UpdateConfig(UpdateConfigInput input)
    {
        ...
        _ = _sysCacheService.Remove(config.Code);
    }
    ...
    /// <returns></returns>
    [DisplayName("获取参数配置详情")]
    [ApiDescriptionSettings(Name = "GetConfigValue"), HttpGet]
    public async Task<string> GetConfigValueAsync([FromQuery] string code)
    {
        ...
        if (string.IsNullOrEmpty(value))
        {
            ...
            _ = _sysCacheService.Set(code, value);
        }
