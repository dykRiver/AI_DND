...
/// 系统用户角色服务
/// </summary>
[ApiDescriptionSettings(Groups = [CommonConst.SysGroupName])]
public class SysUserRoleService : ITransient
{
    ...
    public async Task GrantUserRole(UserRoleInput input)
    {
        ...
        _ = _sysCacheService.Remove(CacheConst.KeyUserButton + input.UserId);
    }
    ...
    public async Task DeleteUserRoleByUserId(long userId)
    {
        ...
        _ = _sysCacheService.Remove(CacheConst.KeyUserButton + userId);
    }
