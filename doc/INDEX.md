...
| [AI系统架构](architecture/ai-architecture.md) | 六AI角色（分类/前台导演/**书记官**/物资官/叙事/建筑师）、**文学引擎三层架构**、**节拍分档与章节档分段生成**、协作流程、**关键路径与并行化（延迟治理）**、判定信息流、**局面快照**、**资产账本**（三态门卫 + 书记官记账 + 物资官依书记官蓝图落库）、DC标尺、**行动选项预计算机制** |
