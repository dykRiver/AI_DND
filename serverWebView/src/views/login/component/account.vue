<template>
	<el-form ref="ruleFormRef" :model="state.ruleForm" size="large" :rules="state.rules" class="login-content-form">
		<el-form-item class="login-animation1" prop="account">
			<el-input ref="accountRef" text placeholder="请输入账号" class="login-input" v-model="state.ruleForm.account"
		...
		<el-form-item class="login-animation2" prop="password">
			<el-input ref="passwordRef" :type="state.isShowPassword ? 'text' : 'password'" placeholder="请输入密码"
				class="login-input" v-model="state.ruleForm.password" autocomplete="off"
		...
		<div class="font12  login-animation4 login-msg">{{ $t('message.mobile.msgText') }}</div>
...
.login-content-form {
	...
	.login-input {
		--el-input-bg-color: #F5F1EB;
		--el-input-border-radius: .8rem;
	}
	...
	.login-content-submit {
		...
		font-weight: 550;
		font-size: 2rem;
		--el-border-radius-round: .8rem;
		--el-color-primary: #00a08a;
		--el-color-primary-light-3: #00917f;
	}
