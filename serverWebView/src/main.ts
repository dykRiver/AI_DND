...
import VForm3 from '@/../lib/nocode/dist/designer.umd.js';
import '@/../lib/nocode/dist/designer.style.css';// VForm3表单设计样式
//import VForm3x from '/@/nocode/dist/designer.umd.js';// VForm3表单设计
